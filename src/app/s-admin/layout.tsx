...
import { SuperAdminSidebar } from "@/features/s-admin/components/super-admin-sidebar";
...
export default async function S_AdminLayout({
  children,
}: {
  ...
  // return (
  //   <RoleGuard allowedRoles={[UserRole.S_ADMIN]}>
  ...
  //           </div>
  //         </header>
  //         <main className="bg-background m-4 min-h-[calc(100vh-6rem)] rounded-xl border">
  //           {children}
  //         </main>
  //       </SidebarInset>
  //     </SidebarProvider>
  ...
  return (
    <RoleGuard allowedRoles={[UserRole.S_ADMIN]}>
      <SidebarProvider defaultOpen={defaultOpen}>
        <AppSidebar roleVariant="s_admin" />
        <SidebarInset>
